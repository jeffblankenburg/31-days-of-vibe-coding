...
This repo contains:
- **`/_posts`** - Full blog posts for each day (Jekyll format)
- **`/examples`** - Code samples, prompts, and templates from the series
- **`31-DAYS-TACTICAL-OUTLINE.md`** - Complete series outline with all topics
...
This series primarily uses **Claude** for examples, but the techniques work across AI coding tools. Day 28 covers the AI tool landscape and when to use what.
